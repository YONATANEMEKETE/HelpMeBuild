...
const ProjectCard = ({ project }: { project: ProjectState }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-mybg rounded-md overflow-clip max-w-[400px]  min-[620px]:max-w-[300px] min-w-[250px] w-[300px] shrik grow md:grow-0 h-fit border-x border-b border-mytextlight/20 cursor-pointer"
    >
      <div
